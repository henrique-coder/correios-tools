...
```powershell
irm https://henrique-coder.github.io/correios-tools/install.ps1 | iex
```

**Alternativa via CMD:**

```cmd
powershell -ep bypass -c "irm https://henrique-coder.github.io/correios-tools/install.ps1 | iex"
```
